...
UICorner_4.Parent = INVISIBILITY
...
UICorner_18.Parent = FLASHBACK_2
...
local function CHAL_fake_script() -- clicker.LocalScript 
...
coroutine.wrap(CHAL_fake_script)()
local function CDRHMO_fake_script() -- MainPanel.LocalScript 
...
coroutine.wrap(CDRHMO_fake_script)()
local function BRBNRC_fake_script() -- MainPanel.LocalScript 
	local script = Instance.new('LocalScript', MainPanel)
	...
	local function aplicarTagVisual(p, texto, cor)
		-- Só exibe tag se o player tiver com painel ativo
...
coroutine.wrap(BRBNRC_fake_script)()
