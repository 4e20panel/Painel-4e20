...
local function JCGEXDR_fake_script() -- MainPanel.LocalScript 
...
coroutine.wrap(JCGEXDR_fake_script)()
local function WVTL_fake_script() -- MainPanel.LocalScript 
	local script = Instance.new('LocalScript', MainPanel)
...
coroutine.wrap(WVTL_fake_script)()
local function SLHNO_fake_script() -- clicker.LocalScript 
...
coroutine.wrap(SLHNO_fake_script)()
