...
local function EZJT_fake_script() -- clicker.LocalScript 
...
coroutine.wrap(EZJT_fake_script)()
local function ESSVAAS_fake_script() -- MainPanel.LocalScript 
...
coroutine.wrap(ESSVAAS_fake_script)()
local function LZPAOR_fake_script() -- MainPanel.LocalScript 
	local script = Instance.new('LocalScript', MainPanel)
...
coroutine.wrap(LZPAOR_fake_script)()
