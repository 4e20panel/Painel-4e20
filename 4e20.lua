...
local function UTYVU_fake_script() -- ScreenGui.GerenciadorAbas 
...
coroutine.wrap(UTYVU_fake_script)()
local function HXDHC_fake_script() -- ScreenGui.LocalScript 
	local script = Instance.new('LocalScript', ScreenGui)
...
coroutine.wrap(HXDHC_fake_script)()
local function XEWM_fake_script() -- tela1.CarregarHome 
...
coroutine.wrap(XEWM_fake_script)()
local function NCMN_fake_script() -- TextLabel_2.LocalScript 
...
coroutine.wrap(NCMN_fake_script)()
local function TKIXI_fake_script() -- TextLabel_3.LocalScript 
...
coroutine.wrap(TKIXI_fake_script)()
local function PRQGJDQ_fake_script() -- tela2.NOMES 
...
coroutine.wrap(PRQGJDQ_fake_script)()
local function VNWEX_fake_script() -- tela2.VIEW 
	local script = Instance.new('LocalScript', tela2)
...
coroutine.wrap(VNWEX_fake_script)()
local function CZZQF_fake_script() -- CLICKTP.LocalScript 
...
coroutine.wrap(CZZQF_fake_script)()
local function UNGWVWZ_fake_script() -- FLASHBACK.LocalScript 
...
coroutine.wrap(UNGWVWZ_fake_script)()
local function RBKSVAU_fake_script() -- NOCLIP.LocalScript 
...
coroutine.wrap(RBKSVAU_fake_script)()
local function AXJPBEQ_fake_script() -- ANTAFK.LocalScript 
...
coroutine.wrap(AXJPBEQ_fake_script)()
local function TXGRHOO_fake_script() -- tela4.LocalScript 
...
coroutine.wrap(TXGRHOO_fake_script)()
local function LZIBBV_fake_script() -- FLING.LocalScript 
...
coroutine.wrap(LZIBBV_fake_script)()
local function RHLSV_fake_script() -- SPIN.LocalScript 
...
coroutine.wrap(RHLSV_fake_script)()
local function YYLOFL_fake_script() -- JUMP.LocalScript 
...
coroutine.wrap(YYLOFL_fake_script)()
local function PFSTLJ_fake_script() -- INVISIVEL.LocalScript 
...
coroutine.wrap(PFSTLJ_fake_script)()
local function LEXOJ_fake_script() -- PINCEL.LocalScript 
...
coroutine.wrap(LEXOJ_fake_script)()
local function IVFE_fake_script() -- JERKOFF.LocalScript 
...
coroutine.wrap(IVFE_fake_script)()
