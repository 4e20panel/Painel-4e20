...
local function OAAS_fake_script() -- MainPanel.LocalScript 
...
coroutine.wrap(OAAS_fake_script)()
local function QCPMTF_fake_script() -- MainPanel.LocalScript 
	local script = Instance.new('LocalScript', MainPanel)
...
coroutine.wrap(QCPMTF_fake_script)()
local function MVFOV_fake_script() -- clicker.LocalScript 
...
coroutine.wrap(MVFOV_fake_script)()
